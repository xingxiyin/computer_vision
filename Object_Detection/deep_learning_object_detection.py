...
CLASSES = ["background", "aeroplane", "bicycle", "bird", "boat", "bottle",
           "bus", "cat", "chair", "cow", "diningtable", "dog", "horse", "motorbike",
...
# Loop through the detections and determine what and where the objects are in the image
for i in np.arange(start=0, detections.shape[2]):
